...
public class arabamCom {
    ...
    public void arabamTest() throws InterruptedException {
        ...
        //456 618
        Thread.sleep(2000);
        action.press(PointOption.point(408, 757))
                .release()
                .perform();
        // aracin km bilgilerini girelim
        AndroidElement kmBox = driver.findElementById("com.dogan.arabam:id/et_km");
        if (driver.isKeyboardShown()) {  //eger klavyem gozukuyorsa
            driver.getKeyboard().pressKey("150000");  // klavyemi ortaya cikar anlaminda getKeyboard
        } else {
            kmBox.sendKeys("100000");  // egeer klavyem gozukmuyorsa kmboxa rakam gonder
        }
        Thread.sleep(1000);
        ...
        ortalamaSonSonuc = ortalamaSonSonuc.replaceAll("\\D", ""); //rakam olmayan herseyi bosluga cevir
